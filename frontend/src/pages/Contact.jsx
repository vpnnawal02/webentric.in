                        ...
                        <div className="bg-white border border-gray-200 rounded-sm shadow-sm p-6 flex justify-between">
                            ...
                            <div className="space-y-3 text-sm text-gray-700">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-800">+91 9560342636</p>
                                </div>
                                <div>
                                    <p className="text-gray-500 text-xs uppercase tracking-wide">
                                        Availability
                            ...
                            <div className="flex flex-col items-center gap-4 justify-around">
                                <a href="https://www.linkedin.com/company/webentric" className="group hover:text-blue-400 transition-colors">
                                ...
                                {/* whatsapp */}
                                <a href="https://wa.me/message/IK7VVIWKOELZL1" className="group hover:text-blue-400 transition-colors">
                                <img className="w-7 h-7" src="https://img.icons8.com/material-outlined/96/whatsapp--v1.png" alt="whatsapp--v1"/>
                                </a>
