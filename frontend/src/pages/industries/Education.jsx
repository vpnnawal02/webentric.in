...
export default function Education() {
    return (
        <main className="bg-page text-ink min-h-screen">
            <SEO
                title="School Website Development India | Webentric"
                description={DESCRIPTION}
                keywords={["school website development", "school website India", "educational institute website Delhi"]}
                canonical={`${SITE.url}/industries/education`}
                schema={[
                    webPageSchema({
                        name: "School Website Development India | Webentric",
                        url: `${SITE.url}/industries/education`,
                        description: DESCRIPTION,
                    }),
                    faqSchema(FAQS),
                    breadcrumbSchema([
                        ...
                        { name: "Industries" },
                        { name: "Education", url: `${SITE.url}/industries/education` },
                    ]),
                ]}
            />
