            ...
            <div className="max-w-7xl mx-auto px-6 py-20">
              ...
              `}
                        >
                            ...
                            <h3 className="text-2xl font-semibold text-gray-900 mb-4 text-center">{plan.title}</h3>
                            <div className="text-4xl font-bold text-blue-600 mb-2 text-center">{plan.price}</div>
                            <p className="text-gray-500 text-sm text-center mb-8">{plan.delivery}</p>

                            <ul className="space-y-0 md:space-y-1 mb-10">
                                {plan.features.map((feature, fIndex) => (
                                    <li
                                        key={fIndex}
                                        className="flex items-start gap-3 p-3 rounded-sm hover:bg-gray-50 cursor-help transition-all group"
                            ...
                            <button className="w-full bg-blue-600 text-white py-3 px-6 rounded-xs font-semibold hover:bg-blue-700 transition-all duration-200 shadow-sm">
                ...
                {/* 3. Add-ons */}
                <div className="mb-24">
                    <h3 className="text-3xl font-semibold text-gray-900 text-center mb-12">Optional Add-ons</h3>
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        {addons.map((addon, index) => (
                            <div key={index} className="bg-gray-50 border border-gray-200 rounded-xs p-6 text-center hover:bg-white hover:shadow-sm transition-all">
                ...
                <div className="text-center max-w-2xl mx-auto mb-24 space-y-6">
                    ...
                    <p className="text-lg text-gray-600">
                        Every business is different. If your project requires unique features, integrations,
                        or a fully custom design, we can build a tailored solution for your business.
                    </p>
                    <button className="bg-blue-600 text-white px-8 py-4 rounded-xs font-semibold text-lg hover:bg-blue-700 transition-all shadow-lg hover:shadow-xl">
