...
export default function CustomWebsitePage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-page via-surface to-indigo-50/30">
            {/* ── 1. Hero Section ── */}
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="lg:pr-12">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                ...
                                <a href="#capabilities" className="inline-flex items-center px-8 py-4 border-2 border-line rounded-xl text-lg font-semibold text-ink hover:bg-subtle hover:border-edge transition-all duration-200">
                                    View Capabilities
                                </a>
                            </div>
                        </div>
            ...
            <div className="max-w-7xl mx-auto px-6 pb-20">
                ...
                <section id="capabilities" className="mb-24">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl lg:text-4xl font-bold text-ink mb-4">Who Needs a Custom Website?</h2>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        {[
                            ...
                            <div key={i} className="group bg-surface rounded-2xl p-6 border border-line hover:shadow-xl hover:shadow-indigo-100 transition-all duration-300 hover:-translate-y-2">
                ...
                <section className="mb-24">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl lg:text-4xl font-bold text-ink mb-4">What We Can Build</h2>
                        <p className="text-xl text-muted max-w-2xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {[
                            ...
                            <div key={i} className="group bg-surface/80 backdrop-blur-sm rounded-2xl p-8 border border-line hover:bg-surface hover:shadow-2xl transition-all duration-300 hover:-translate-y-3">
                ...
                <section className="mb-24">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl lg:text-4xl font-bold text-ink mb-4">Technologies We Use</h2>
                        <p className="text-xl text-muted max-w-2xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            <div key={i} className="text-center group">
                                <div className="bg-gradient-to-br from-subtle to-subtle rounded-2xl p-8 border border-line hover:shadow-xl transition-all duration-300">
                                    ...
                                    <div className="space-y-3">
                                        {stack.techs.map((tech) => (
                                            <div key={tech} className="group-hover:scale-105 transition-transform">
                                                <span className="inline-block px-4 py-2 bg-surface rounded-lg shadow-sm border border-line font-semibold text-ink">
                                                    {tech}
                                                </span>
                                            </div>
                                        ))}
                ...
                <section className="mb-24">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl lg:text-4xl font-bold text-ink mb-4">Our Development Process</h2>
                        <p className="text-xl text-muted max-w-2xl mx-auto">
                        ...
                        <div className="grid lg:grid-cols-6 gap-8 lg:gap-0 items-center">
                            {[
                                ...
                                <div key={i} className={`relative z-10 ${i % 2 ? "lg:order-1" : "lg:order-2"}`}>
                                    <div className="bg-surface rounded-2xl p-6 shadow-lg border border-line hover:shadow-xl hover:shadow-indigo-100 transition-all duration-300">
                ...
                <section className="mb-24">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl lg:text-4xl font-bold text-ink mb-4">Estimated Pricing Range</h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            ...
                            <div key={i} className="group bg-gradient-to-b from-surface to-subtle rounded-2xl p-8 border border-line hover:shadow-2xl hover:shadow-indigo-100 transition-all duration-300 hover:-translate-y-2">
                                <h3 className="font-bold text-xl text-ink mb-4">{plan.title}</h3>
                                ...
                                <p className="text-xs text-muted italic bg-indigo-50 border border-indigo-100 rounded-lg px-3 py-2">
                ...
                <section id="form" className="mb-24">
                    <div className="max-w-2xl mx-auto">
                        <div className="bg-surface rounded-3xl shadow-2xl border border-line p-8 lg:p-12">
                            <div className="text-center mb-10">
                                <h2 className="text-3xl font-bold text-ink mb-3">Get Your Custom Project Estimate</h2>
                                <p className="text-xl text-muted">Tell us about your project and we'll provide a detailed quote within 24 hours.</p>
                            </div>
                            <form onSubmit={submitForm} className="grid md:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-sm font-semibold text-ink/80 mb-2">Full Name *</label>
                                    <input
                                        required
                                        name="name"
                                        value={form.name}
                                        onChange={handleChange}
                                        className="w-full px-4 py-3 border border-line rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                                ...
                                <div>
                                    <label className="block text-sm font-semibold text-ink/80 mb-2">Company (Optional)</label>
                                    <input
                                        name="company"
                                        value={form.company}
                                        onChange={handleChange}
                                ...
                                <div>
                                    <label className="block text-sm font-semibold text-ink/80 mb-2">Website Type</label>
                                    <select
                                        name="websiteType"
                                ...
                                <div>
                                    <label className="block text-sm font-semibold text-ink/80 mb-2"># of Pages</label>
                                    <select
                                        name="pages"
                                        value={form.pages}
                                        onChange={handleChange}
                                ...
                                <div>
                                    <label className="block text-sm font-semibold text-ink/80 mb-2">Timeline</label>
                                    <select
                                        name="timeline"
                                        value={form.timeline}
                                        onChange={handleChange}
                                ...
                                <div>
                                    <label className="block text-sm font-semibold text-ink/80 mb-2">Budget Range</label>
                                    <select
                                        name="budget"
                                        value={form.budget}
                                        onChange={handleChange}
                                ...
                                <div className="md:col-span-2">
                                    <label className="block text-sm font-semibold text-ink/80 mb-2">Required Features</label>
                                    <textarea
                                        name="features"
                                        value={form.features}
                                        onChange={handleChange}
                                        ...
                                        className="w-full px-4 py-3 border border-line rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all resize-vertical"
                                    />
                                </div>
                                <div className="md:col-span-2">
                                    <label className="block text-sm font-semibold text-ink/80 mb-2">Additional Details</label>
                                    <textarea
                                        name="details"
                                        value={form.details}
                                        onChange={handleChange}
                ...
                <section className="mb-24">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-3xl font-bold text-ink text-center mb-12">Frequently Asked Questions</h2>
                        <div className="space-y-4">
                            {[
                                ...
                                <div key={i} className="group bg-surface rounded-2xl border border-line p-6 hover:shadow-lg transition-all duration-200">
                                    <details className="cursor-pointer">
                                        <summary className="font-semibold text-ink text-lg marker:text-indigo-500 list-none flex items-center gap-3 pb-3">
                                            <span className="text-indigo-600 text-2xl">Q</span>
                                            {faq.q}
                                            <svg className="w-5 h-5 text-muted ml-auto group-hover:rotate-180 transition-transform" fill="none" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                                            </svg>
                                        </summary>
                                        <p className="mt-4 text-muted pl-8 pt-2 border-l-4 border-indigo-100">{faq.a}</p>
                                    </details>
                                </div>
                            ))}
                        </div>
