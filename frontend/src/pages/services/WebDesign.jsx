        ...
        <main className="bg-page text-ink min-h-screen">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-8 md:px-16 lg:px-24 pt-24 md:pt-28 pb-20">
                ...
                <div className="max-w-3xl space-y-4 text-muted text-[15px] sm:text-base leading-relaxed mb-14 md:mb-20">
                    <p>
                        Visitors decide quickly whether to stay or leave. Clear hierarchy,
                        honest copy, and a calm visual direction help them understand what
                        you offer and what to do next. We shape pages around that moment —
                        especially for first-time visitors arriving from search or social.
                    </p>
                    <p>
                        From startups to cafes and fitness studios, we plan interfaces that
                        are easy to scan on a phone, consistent with your brand, and tied to
                        a single action per section: enquire, book, call, or visit. Layouts
                        are built in React with Tailwind CSS and JavaScript, with Firebase
                        or Supabase added when forms need storage.
                    </p>
                </div>
