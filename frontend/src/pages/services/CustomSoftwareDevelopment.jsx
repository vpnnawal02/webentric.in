    ...
    return (
        <main className="bg-page text-ink min-h-screen">
            <SEO
                ...
                schema={[
                    webPageSchema({
                        name: "Custom Software Built Around Your Business",
                        url: URL,
                        description: DESCRIPTION,
                    }),
                    {
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-8 md:px-16 lg:px-24 pt-24 md:pt-28 pb-20">
                <Breadcrumbs
                    items={[{ label: "Services" }, { label: "Custom Software", to: "/custom-software-development" }]}
                />
                <p className="text-xs uppercase tracking-[0.22em] text-muted mb-4">
                    Services — Tailored Business Systems
                </p>
                ...
                <div className="max-w-3xl space-y-4 text-muted text-[15px] sm:text-base leading-relaxed mb-14 md:mb-20">
                    <p>
                        Most of our systems work starts the same way: a business running on spreadsheets, chat
                        threads and memory. Orders live in one sheet, payments in another, follow-ups nowhere at
                        all. It holds together until the team grows — then every new order adds confusion instead
                        of revenue.
                    </p>
                    <p>
                        We replace that patchwork with one clear place to work. Custom software development, done
                        this way, is less about technology and more about clarity: who does what, what happens
                        next, and where every record lives. You describe the process; we shape the system around it.
                    </p>
                </div>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                        <div className="bg-surface border border-line p-6">
                            ...
                            <p className="text-sm text-muted leading-relaxed">
                                Recurring steps — assignments, approvals, follow-up reminders — run on rules you
                                define, so routine work moves without chasing.
                            </p>
                        </div>
                        <div className="bg-surface border border-line p-6">
                            <h3 className="font-medium mb-2">Dashboards &amp; reports</h3>
                            <p className="text-sm text-muted leading-relaxed">
                                Daily numbers, pending tasks and team activity in one view, with simple reports you
                                can read without exporting sheets.
                            </p>
                        </div>
                        <div className="bg-surface border border-line p-6">
                            <h3 className="font-medium mb-2">Login, roles &amp; permissions</h3>
                            <p className="text-sm text-muted leading-relaxed">
                                Secure sign-in with role-based access, so owners, managers and staff each see
                                exactly what their job needs.
                            </p>
                        </div>
                        <div className="bg-surface border border-line p-6">
                            <h3 className="font-medium mb-2">Database &amp; API foundation</h3>
                            <p className="text-sm text-muted leading-relaxed">
                                Structured data on Firebase or Supabase with REST API integration, so records stay
                                consistent as you add modules.
                            </p>
                        </div>
                        <div className="bg-surface border border-line p-6">
                            <h3 className="font-medium mb-2">Payments &amp; notifications</h3>
                            <p className="text-sm text-muted leading-relaxed">
                                Razorpay, Stripe, UPI or PayPal collection wired into your flow, with WhatsApp and
                                SMTP updates for your team and customers.
                            </p>
                        </div>
                        <div className="bg-surface border border-line p-6">
                            <h3 className="font-medium mb-2">Lead management &amp; billing basics</h3>
                            <p className="text-sm text-muted leading-relaxed">
                                CRM-style lead tracking from first enquiry to closure, plus straightforward
                                invoicing and reporting basics.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="mt-16 md:mt-20">
                    ...
                    <div className="border border-line divide-y divide-line">
                        <div className="px-6 py-5">
                            ...
                            <p className="text-sm text-muted leading-relaxed">
                                No adapting your team to someone else&apos;s fields and menus — the system mirrors
                        ...
                        <div className="px-6 py-5">
                            ...
                            <p className="text-sm text-muted leading-relaxed">
                                Orders, payments, tasks and follow-ups stop living across five sheets and three
                                chat groups.
                            </p>
                        </div>
                        <div className="px-6 py-5">
                        ...
                        <div className="px-6 py-5">
                            ...
                            <p className="text-sm text-muted leading-relaxed">
                                Start with the most painful process, then add inventory, billing or reporting when
                        ...
                        <div className="px-6 py-5">
                            ...
                            <p className="text-sm text-muted leading-relaxed">
                                Built for your business and maintained by people you can reach — no subscription
                ...
                <section className="mt-16 md:mt-20">
                    ...
                    <div className="grid sm:grid-cols-2 gap-4 md:gap-6">
                        <div className="bg-surface border border-line p-6">
                            ...
                            <p className="text-sm text-muted leading-relaxed">
                                We study how work actually flows — sheets, calls, registers — and agree what the
                                system must do first.
                            </p>
                        </div>
                        <div className="bg-surface border border-line p-6">
                            ...
                            <p className="text-sm text-muted leading-relaxed">
                                Screens, roles and data fields are sketched around your team, and you approve them
                        ...
                        <div className="bg-surface border border-line p-6">
                            ...
                            <p className="text-sm text-muted leading-relaxed">
                                We develop in React with Firebase or Supabase behind it, wiring payments,
                                notifications and APIs as needed.
                            </p>
                        </div>
                        <div className="bg-surface border border-line p-6">
                            ...
                            <p className="text-sm text-muted leading-relaxed">
                                Your team learns the system with guided handover, and we stay on for fixes, changes
                                and upkeep.
                            </p>
                        </div>
                    </div>
