    ...
    return (
        <main className="bg-page text-ink min-h-screen">
            <SEO
                ...
                canonical={`${SITE.url}/website-maintenance`}
                schema={[
                    webPageSchema({
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-8 md:px-16 lg:px-24 pt-24 md:pt-28 pb-20">
                ...
                <div className="max-w-3xl space-y-4 text-muted text-[15px] sm:text-base leading-relaxed mb-14 md:mb-20">
                    <p>
                        A site is never truly finished. Content goes stale, software needs
                        patching, and small glitches quietly turn visitors away. Regular website
                        maintenance keeps everything updated, backed up, and working — so your
                        pages load, your forms submit, and your business stays reachable.
                    </p>
                    <p>
                        Our support plans cover the day-to-day upkeep businesses across India
                        actually need: content changes, backups with restore, security updates,
                        bug fixes, performance checks, and help with SSL, hosting, and domains.
                        You run your business; we look after the site.
                    </p>
                </div>
