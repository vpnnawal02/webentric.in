    ...
    return (
        <main className="bg-page text-ink min-h-screen">
            <SEO
                ...
                canonical={`${SITE.url}/website-redesign`}
                schema={[
                    webPageSchema({
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-8 md:px-16 lg:px-24 pt-24 md:pt-28 pb-20">
                ...
                <div className="max-w-3xl space-y-4 text-muted text-[15px] sm:text-base leading-relaxed mb-14 md:mb-20">
                    <p>
                        If your site looks dated, loads slowly, or no longer reflects what your
                        business offers, visitors notice — and leave. We help businesses in Delhi
                        and across India replace tired pages with a clean, modern presence that
                        feels current on every device.
                    </p>
                    <p>
                        Every refresh starts with understanding what to keep and what to change.
                        We audit your existing pages, protect the search visibility you have
                        earned, and rebuild the experience in React so it stays fast, easy to
                        update, and ready to grow with you.
                    </p>
                </div>
