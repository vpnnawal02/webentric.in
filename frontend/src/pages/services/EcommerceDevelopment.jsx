    ...
    return (
        <main className="bg-page text-ink min-h-screen">
            <SEO
                ...
                canonical={`${SITE.url}/ecommerce-development`}
                schema={[
                    webPageSchema({
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-8 md:px-16 lg:px-24 pt-24 md:pt-28 pb-20">
                ...
                <div className="max-w-3xl space-y-4 text-muted text-[15px] sm:text-base leading-relaxed mb-14 md:mb-20">
                    <p>
                        Selling online takes more than a product list. Shoppers need to find
                        items fast, trust the checkout, and pay in a way that feels familiar.
                        We create online stores that keep that path short — from homepage to
                        category to cart to payment — on phones as well as desktops.
                    </p>
                    <p>
                        Catalogs, carts, and order records run on React with Firebase or
                        Supabase behind the scenes. Payments connect through Razorpay,
                        Stripe, UPI, or PayPal, and every store ships with analytics-ready
                        events and a search-friendly foundation so you can see what sells
                        and grow steadily.
                    </p>
                </div>
