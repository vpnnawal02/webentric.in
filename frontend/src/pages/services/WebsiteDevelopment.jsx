    ...
    return (
        <main className="bg-page text-ink min-h-screen">
            <SEO
                ...
                canonical={`${SITE.url}/website-development`}
                schema={[
                    webPageSchema({
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-8 md:px-16 lg:px-24 pt-24 md:pt-28 pb-20">
                ...
                <div className="max-w-3xl space-y-4 text-muted text-[15px] sm:text-base leading-relaxed mb-14 md:mb-20">
                    <p>
                        If you run a growing business in Delhi or elsewhere in India, your site
                        is often the first meeting. People check your services, your work, and
                        how to reach you before they ever call. We create clear, fast,
                        mobile-first sites that make that first meeting count.
                    </p>
                    <p>
                        Our work covers both sides of a project: a clean React interface styled
                        with Tailwind CSS, plus a practical backend on Firebase or Supabase.
                        Forms, databases, and third-party tools connect through REST API
                        integration, and every layout follows a search-friendly structure so
                        search engines can read your pages easily.
                    </p>
                </div>
