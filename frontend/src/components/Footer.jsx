        ...
        <footer className="bg-page text-ink border-t border-ink/50">
            <div className="max-w-[1200px] mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 py-20">
                    ...
                    <div>
                        <h3 className="text-ink font-medium text-lg tracking-[-0.02em] mb-6">
                            Quick Links
                        </h3>
                    ...
                    <div>
                        ...
                        <div className="space-y-4 mb-6">
                            <div>
                                <p className="text-xs uppercase tracking-[0.14em] text-ink/35 mb-1">
                                    Phone
                                </p>
                                <a href="tel:+919560342636" className="text-sm text-ink/60 hover:text-ink transition-colors">
                                    +91 9560342636
                                </a>
                            </div>
                            ...
                            <div>
                                ...
                                <a href="mailto:webentric2026@gmail.com" className="text-sm text-ink/60 hover:text-ink transition-colors">
